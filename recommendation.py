...
def main():
    # Read the data
    restaurants_common = read_data("data/restaurants/all_state_rating_rev_common_cities.csv")
    all_state_demo = read_data("data/demographics/all_state_demo_common_cities.csv")
